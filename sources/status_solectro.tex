...
Gestion et Organisation d'événements audiovisuels. Lors de ces dits événements, une buvette payante pourra être ouverte. En fonction de la prestation, une rémunération pour l'association pourra être demandée et fera figure de frais de fonctionnement.

\section*{ARTICLE 3 - SIÈGE SOCIAL}
Le siège social est fixé à la Mairie de Pecqueuse, Place de la Mairie 91470 Pecqueuse.
...
\begin{enumerate}
\item[1°] Le montant des droits d'entrée et des cotisations;
\item[2°] Les subventions de l'État, des départements et des communes.
\item[3°] Toutes les ressources autorisées par les lois et règlements en vigueur.
\end{enumerate}

\section*{ARTICLE 10 - ASSEMBLÉE GÉNÉRALE ORDINAIRE}
L'assemblée générale ordinaire comprend tous les membres de l'association, à quelques titres qu'ils soient. Elle se réunit chaque année au mois de novembre.
...
\begin{enumerate}
\item[1)] Un président ;
\item[2)] Un vice-président ;
\item[4)] Un trésorier, et, si besoin est, un secrétaire.
\end{enumerate}
...
\begin{flushright}
Fait à Pecqueuse, le 03/06/2024

\vspace{1em}

BESSIERE Lucas, Président\\
DELAÎTRE Romain, Vice-Président
\end{flushright}
