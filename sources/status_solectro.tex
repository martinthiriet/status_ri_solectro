...
\item[2°] Les subventions de l'État, des régions, des départements et des communes.
\item[3°] Les donations personnelles sans aucune contrepartie.
\item[4°] La revente des biens de l'association.
\item[5°] Les revenus générés par les prestations fournies.
\item[6°] Toutes les ressources autorisées par les lois et règlements en vigueur.
\end{enumerate}
...
\begin{enumerate}
\item[1)] Un président ;
\item[2)] Des Vices-présidents ;
\item[3)] Un trésorier, et, si besoin est, un secrétaire.
\end{enumerate}
...
\begin{flushright}
Fait à Pecqueuse, le 12/12/2025
